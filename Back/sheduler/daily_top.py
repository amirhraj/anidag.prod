...
fastapi_url = f"{os.getenv('FASTP_API_URL')}/animeTop"
...
for year in years:
    ...
    initial_url = f"{base_url}?token={token}&types=anime-serial&with_material_data=true&sort=shikimori_rating&year={year}"
